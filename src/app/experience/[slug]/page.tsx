...
export default async function Page({
  ...
  return (
    <article className="prose max-w-4xl mx-auto pt-20 py-12">
      {/* 헤더 */}
      <div className="mb-8 pb-6 border-b border-gray-200">
        ...
        {/* 기술 스택 */}
        <div className="mb-6">
          <h3 className="text-lg text-white font-semibold mb-3">Tech Stack</h3>
          <div className="flex flex-wrap gap-2">
            {metadata.techStack.map((tech, i) => (
              <span
                key={i}
                className="px-3 py-1 text-xs font-medium text-black bg-gray-100 rounded-full"
              >
                {tech}
              </span>
            ))}
